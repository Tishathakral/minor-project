  ...
  return (
    <div className="mx-auto px-4 py-12 bg-white dark:bg-neutral-950 transition duration-500 ease-in-out">
      ...
      <p className="text-lg text-center text-gray-700 dark:text-gray-300 mb-12 max-w-2xl mx-auto mt-2">
        Unleash the power of your text with our Keyword Extractor, powered by KeyBERT. Effortlessly extract meaningful keywords and phrases from your input text, helping you identify key themes and insights. Simply type or paste your content, click 'Extract Keywords', and see the important information highlighted in an instant.
      </p>
